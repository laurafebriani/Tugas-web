...
$site_descripstion = get_setting_value('_site_description');
  ...
  <body id="page-top">
    ...
    <div class="container">
      <div class="row">
        ...
        <!-- CV Section -->
        <div class="col-lg-3 mb-5 mb-lg-0">
            <h4 class="text-uppercase mb-4">CV</h4>
            <p class="mt-2">Untuk mendapatkan informasi lebih lanjut, silakan lihat curriculum vitae (CV) saya..</p>
            <!-- Button to download CV -->
            <a class="btn btn-primary btn-sm" href="https://drive.google.com/file/d/1pP3wqgID3uLMizmCUvybtZ6p1YsH3UCT/view?usp=sharing" target="_blank">
        ...
        <div class="col-lg-3 mb-5 mb-lg-0">
          ...
          @if ($tiktok)
            <a class="btn btn-outline-light btn-social mx-1" href="{{ $tiktok }}" target="_blank"><i class="fab fa-fw fa-tiktok"></i></a>
          @endif
        ...
        <div class="col-lg-3">
          ...
          <p class="lead mb-0">{!! $site_descripstion !!}.</p>
        </div>
      </div>
    </div>
  </footer>
